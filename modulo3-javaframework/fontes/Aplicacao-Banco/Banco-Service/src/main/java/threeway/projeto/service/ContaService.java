...
import threeway.projeto.service.DaoJPA.ContaDaoImpl;
...
public class ContaService implements Serializable {
	...
	/**
	 * Método responsável por realizar ação de saque caso não tenha saldo
	...
	/**
	 * Método responsável por realizar transferencia entre contas caso não tenha
	 * saldo suficiente e lançado uma exceção
	 * 
	 * @author Wilker Machado
	 * 
	 * @param contaSaque
	...
	public boolean transferir(Conta contaSaque, double valor, Conta contaDestino)
		...
		return transferir(contaSaque, valor, contaDestino,
				"transferencia para conta " + contaDestino.getNumero());
	}
	 ...
	 * @param tipoTransacao
	 */
	protected void historicoTransacao(Conta contaDebito, Conta contaCredito,
			double valor, String descr, EnumTipoTransacao tipoTransacao) {
	...
	/**
	 * Método responsável por salvar entidade conta validando campos
	 * obrigatorios
	 * 
	 * @author Wilker Machado
	 * 
	...
	/**
	 * Método responsável por buscar conta por numero caso nao exista lança
	 * exceção de ContaNaoExisteException
	 * 
	 * @author Wilker Machado
	 * 
	 * @param numeroConta
