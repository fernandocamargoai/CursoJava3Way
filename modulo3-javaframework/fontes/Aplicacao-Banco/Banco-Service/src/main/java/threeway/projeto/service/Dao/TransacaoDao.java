...
public class TransacaoDao implements Dao<Transacao>, Serializable{

	/** Atributo serialVersionUID. */
	private static final long serialVersionUID = -4104036058544780245L;
	...
	public Collection<Transacao> listar() {
		...
		try {
			...
			while (resultado.next()) {
				...
				transacao.setContaCredito(contaDao.obter(resultado.getLong("id_contaCredito")));

				transacao.setContaDebito(contaDao.obter(resultado.getLong("id_contaDebito")));
