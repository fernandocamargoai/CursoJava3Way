...
public class Login extends AppController {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// recupera do form atrav�s do request o valor do input com o name login
		final String login = request.getParameter("login");
						
		// recupera do form atrav�s do request o valor do input com o name senha
		...
		if (("admin".equals(login)) && "admin".equals(senha)){			
			...
			//Limpando o campo mensagem da sess�o
			...
			//adicionando os campos agencia e banco na sess�o
			this.getRequest().getSession().setAttribute("agencia", agenciaService.agenciaSistema());
			
			//Esta funcionalidade ser� ensinada nas proximas aulas
